		...
		uglify: {
			my_target:{
				files: {
					...
					'_/js/scripts2.js': ['_/components/js/testsvg.js'],
					'_/js/testSrollmagic.js': ['_/components/js/testSrollmagic.js'],
					'_/js/scriptsRotateSVG.js': ['_/components/js/scriptsRotateSVG.js']
